...
export const useCartStore = create((set, get) => ({
    ...
    addToCart: async (product) => {
        try {
            ...
            set((prevState) => {
                ...
                // If the item already exists in the cart, increment the quantity by 1, else add it
    ...
    calculateTotals: () => {
        ...
        // Calculate subtotal by summing up the price of each item times its quantity
